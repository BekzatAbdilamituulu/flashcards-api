...
def test_auto_preview_does_not_use_db_cache_between_calls_when_preview_does_not_save(
    client, monkeypatch, setup_user_pair
):
...
def test_auto_preview_returns_suggestions_and_does_not_save_cache(
